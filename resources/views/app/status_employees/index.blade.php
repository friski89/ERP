                        ...
                        <tr>
                            ...
                            <td class="text-center" style="width: 134px;">
                                <div
                                    ...
                                    class="btn-group"
                                >
                                    @can('update', $statusEmployee)
                                    <a
                                        href="{{ route('status-employees.edit', $statusEmployee) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    @endcan @can('view', $statusEmployee)
                                    <a
                                        href="{{ route('status-employees.show', $statusEmployee) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    @endcan @can('delete', $statusEmployee)
                                    <form
                                        action="{{ route('status-employees.destroy', $statusEmployee) }}"
                                        method="POST"
