        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-borderless table-hover">
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="width: 134px;">
                                <div
                                    ...
                                    class="btn-group"
                                >
                                    @can('update', $cityRecuite)
                                    <a
                                        href="{{ route('city-recuites.edit', $cityRecuite) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    @endcan @can('view', $cityRecuite)
                                    <a
                                        href="{{ route('city-recuites.show', $cityRecuite) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    @endcan @can('delete', $cityRecuite)
                                    <form
                                        action="{{ route('city-recuites.destroy', $cityRecuite) }}"
                                        method="POST"
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="2">{!! $cityRecuites->render() !!}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
