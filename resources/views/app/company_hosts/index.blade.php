        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-borderless table-hover">
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="width: 134px;">
                                <div
                                    ...
                                    class="btn-group"
                                >
                                    @can('update', $companyHost)
                                    <a
                                        href="{{ route('company-hosts.edit', $companyHost) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    @endcan @can('view', $companyHost)
                                    <a
                                        href="{{ route('company-hosts.show', $companyHost) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    @endcan @can('delete', $companyHost)
                                    <form
                                        action="{{ route('company-hosts.destroy', $companyHost) }}"
                                        method="POST"
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="2">{!! $companyHosts->render() !!}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
