        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-borderless table-hover">
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="width: 134px;">
                                <div
                                    ...
                                    class="btn-group"
                                >
                                    @can('update', $jobFunction)
                                    <a
                                        href="{{ route('job-functions.edit', $jobFunction) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    @endcan @can('view', $jobFunction)
                                    <a
                                        href="{{ route('job-functions.show', $jobFunction) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    @endcan @can('delete', $jobFunction)
                                    <form
                                        action="{{ route('job-functions.destroy', $jobFunction) }}"
                                        method="POST"
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="2">{!! $jobFunctions->render() !!}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
