...
class SubStatusUsersController extends Controller
{
    /**
     ...
     */
    public function index(Request $request, SubStatus $subStatus)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(Request $request, SubStatus $subStatus)
    {
        ...
        $user = $subStatus->users()->create($validated);
