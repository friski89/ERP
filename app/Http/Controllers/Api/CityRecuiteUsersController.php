...
class CityRecuiteUsersController extends Controller
{
    /**
     ...
     */
    public function index(Request $request, CityRecuite $cityRecuite)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(Request $request, CityRecuite $cityRecuite)
    {
        ...
        $user = $cityRecuite->users()->create($validated);
