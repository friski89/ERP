...
class JobFunctionUsersController extends Controller
{
    /**
     ...
     */
    public function index(Request $request, JobFunction $jobFunction)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(Request $request, JobFunction $jobFunction)
    {
        ...
        $user = $jobFunction->users()->create($validated);
